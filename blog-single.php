...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item"><a href="blog.php" class="nav-link">feedback</a></li>
	...
	{
		//$id=$_GET['id'];
	//$sql=mysqli_query($conn,"select * from all_jobs where job_id='$id'");
		$title=$row['job_title'];
		$des=$row['des'];
		$country=$row['country'];
		$state=$row['state'];
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <h2 class="mb-3"><td><?php echo $title=$row['job_title'];?></td></h2>
			<h5><?php echo $country=$row['country']; ?>,<?php echo $state=$row['state']; ?>,<?php echo$city=$row['city'];?></h5>
            <p><?php echo $des=$row['des'];?></p>
			
			<form action="apply_job.php" id="JobPortal"method="post" entype="multipart/form-data"style="border: 1px solid gray">
			<div style="padding: 2%">
			  <input type="hidden" name="job_seeker" value="<?php echo $_SESSION['email']; ?>" id="job_seeker">
			   <input type="hidden" name="id_job" value="<?php echo $id_job=$row['job_id']; ?>" id="id_job">
			<div class="row">
		     <div class="col-sm-6">
